...
func (j *jsiiProxy_Role) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Role) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Role) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_Role) IsSuperAdminRole() cdktf.IResolvable {
...
func (j *jsiiProxy_Role) IsSystemRole() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isSystemRole",
...
func (j *jsiiProxy_Role) Privileges() RolePrivilegesList {
	var returns RolePrivilegesList
	_jsii_.Get(
		j,
		"privileges",
		&returns,
...
func (j *jsiiProxy_Role) PrivilegesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"privilegesInput",
...
func NewRole(scope constructs.Construct, id *string, config *RoleConfig) Role {
	...
	_jsii_.Create(
		"@cdktf/provider-googleworkspace.role.Role",
...
func (j *jsiiProxy_Role)SetDescription(val *string) {
...
func (r *jsiiProxy_Role) PutPrivileges(value interface{}) {
	if err := r.validatePutPrivilegesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
...
func (r *jsiiProxy_Role) ResetDescription() {
	_jsii_.InvokeVoid(
		r,
		"resetDescription",
		nil, // no parameters
