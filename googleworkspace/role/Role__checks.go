...
func (r *jsiiProxy_Role) validatePutPrivilegesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*RolePrivileges; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Role) validateSetDescriptionParameters(val *string) error {
	if val == nil {
