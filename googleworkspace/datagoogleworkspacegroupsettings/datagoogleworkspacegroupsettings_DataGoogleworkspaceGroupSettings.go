...
import (
	...
	"github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3/datagoogleworkspacegroupsettings/internal"
...
func (j *jsiiProxy_DataGoogleworkspaceGroupSettings) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGoogleworkspaceGroupSettings)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
