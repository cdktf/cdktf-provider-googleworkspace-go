...
import (
	...
	"github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8/orgunit/internal"
...
func (j *jsiiProxy_OrgUnit) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_OrgUnit)SetCount(val interface{}) {
...
func OrgUnit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrgUnit_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrgUnit) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrgUnit) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OrgUnit) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrgUnit) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrgUnit) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OrgUnit) MoveToId(id *string) {
...
func (o *jsiiProxy_OrgUnit) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OrgUnit) ToHclTerraform() interface{} {
	var returns interface{}
