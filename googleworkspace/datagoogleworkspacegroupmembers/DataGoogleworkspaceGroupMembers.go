...
func (j *jsiiProxy_DataGoogleworkspaceGroupMembers) Count() interface{} {
...
func (j *jsiiProxy_DataGoogleworkspaceGroupMembers)SetCount(val interface{}) {
...
func (d *jsiiProxy_DataGoogleworkspaceGroupMembers) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGoogleworkspaceGroupMembers) ToHclTerraform() interface{} {
	var returns interface{}
