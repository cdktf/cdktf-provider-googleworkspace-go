...
func (j *jsiiProxy_GroupMember) validateSetDeliverySettingsParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GroupMember) validateSetEmailParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_GroupMember) validateSetRoleParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_GroupMember) validateSetTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
