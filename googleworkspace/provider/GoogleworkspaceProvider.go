...
import (
	...
	"github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8/provider/internal"
...
func GoogleworkspaceProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleworkspaceProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleworkspaceProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleworkspaceProvider) ToHclTerraform() interface{} {
	var returns interface{}
