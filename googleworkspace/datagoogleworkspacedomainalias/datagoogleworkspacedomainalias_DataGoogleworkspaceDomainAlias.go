...
import (
	...
	"github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v2/datagoogleworkspacedomainalias/internal"
...
func (j *jsiiProxy_DataGoogleworkspaceDomainAlias) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGoogleworkspaceDomainAlias)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
