...
func (j *jsiiProxy_DataGoogleworkspaceUser) Count() interface{} {
...
func (j *jsiiProxy_DataGoogleworkspaceUser)SetCount(val interface{}) {
...
func DataGoogleworkspaceUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleworkspaceUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleworkspaceUser) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGoogleworkspaceUser) ToHclTerraform() interface{} {
	var returns interface{}
