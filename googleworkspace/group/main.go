...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googleworkspace.group.GroupConfig",
		reflect.TypeOf((*GroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googleworkspace.group.GroupTimeouts",
		reflect.TypeOf((*GroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googleworkspace.group.GroupTimeoutsOutputReference",
