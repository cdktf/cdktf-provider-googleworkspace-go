...
func (j *jsiiProxy_DataGoogleworkspaceChromePolicySchema) Count() interface{} {
...
func (j *jsiiProxy_DataGoogleworkspaceChromePolicySchema)SetCount(val interface{}) {
...
func DataGoogleworkspaceChromePolicySchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleworkspaceChromePolicySchema_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleworkspaceChromePolicySchema) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGoogleworkspaceChromePolicySchema) ToHclTerraform() interface{} {
	var returns interface{}
