...
import (
	...
	"github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8/datagoogleworkspaceorgunit/internal"
...
func (j *jsiiProxy_DataGoogleworkspaceOrgUnit) Count() interface{} {
...
func (j *jsiiProxy_DataGoogleworkspaceOrgUnit)SetCount(val interface{}) {
...
func DataGoogleworkspaceOrgUnit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleworkspaceOrgUnit_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleworkspaceOrgUnit) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGoogleworkspaceOrgUnit) ToHclTerraform() interface{} {
	var returns interface{}
